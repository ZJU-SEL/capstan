...
// Workload represents the mysql workload.
...
// Ensure mysql Workload implements workload.Interface
...
// TestingTool initializes a new testing tool for this mysql workload (to adhere to workload.Interface).
