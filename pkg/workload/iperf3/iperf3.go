...
// GetName returns the name of this iperf3 workload (to adhere to workload.Interface).
func (w *Workload) GetName() string {
	return w.Name
}

// GetImage returns the image name of this iperf3 workload (to adhere to workload.Interface).
